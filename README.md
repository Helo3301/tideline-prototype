...
1. **The redesign** — 10 prototype pages (8 public + 2 member-area) with a shared design system in `styles.css`.
...
1. Visit https://helo3301.github.io/riverbend-prototype/ — the prototype index, with all 10 pages, all 10 AI reference mockups, and the three documents linked.
